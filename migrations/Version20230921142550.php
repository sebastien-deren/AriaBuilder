 ...
 */
final class Version20230921142550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE background (id INT NOT NULL, competence_bonus_id INT NOT NULL, competence_malus_id INT NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
